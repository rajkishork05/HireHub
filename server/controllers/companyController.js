...
export const registerCompany = async (req, res) => {
    ...
    try {
        ...
        // console.log("password hashed") testing
        ...
        // console.log("company created") testing
        ...
        // console.log("response sent token generated")  testing
...
export const loginCompany = async (req, res) => {
    ...
    try {
        ...
        res.json({
            success: true, message: "Login successful", company: {
                _id: company._id,
                name: company.name,
                email: company.email,
                image: company.image
...
export const postJob = async (req, res) => {
    ...
    // console.log("body mil gyi")
    const companyId = req.company._id;
    // console.log("company id mil gyi")
