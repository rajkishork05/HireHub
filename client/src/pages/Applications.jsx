    ...
    <div className='flex gap-2 mb-6 mt-3 ' > 
      {
        ...
        <label className='flex items-center' htmlFor="resumeUpload">
          <p className='bg-blue-100 text-blue-600 px px-4 py-2 rounded-lg mr-2 cursor-pointer ' >{resume ? resume.name: "Select Resume"}</p>
        ...
        <button onClick={updateResume} className='bg-green-100 border cursor-pointer border-green-400 rounded-lg px-4 py-2 ' >Save</button>
        </> : 
        <div className='flex gap-2' >
          <a className='bg-blue-100 text-blue-600 px-4 py-2 rounded-lg' href={userData.resume} target='_blank' >Resume</a>
          <button onClick={()=> setisEdit(true)} className='text-gray-500 border cursor-pointer border-gray-300 rounded-lg px-4 py-2' >Edit</button>
        </div>
      }
    </div>
    <div>
