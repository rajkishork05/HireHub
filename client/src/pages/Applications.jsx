    ...
    <div className='flex gap-2 mb-6 mt-3' > 
      {
        ...
        <label className='flex items-center' htmlFor="resumeUpload">
          <p className='bg-blue-100 text-blue-600 px px-4 py-2 rounded-lg mr-2' >select Resume</p>
      ...
      <table className='min-w-full bg-white border rounded-lg' >
        ...
        <tbody>
          {jobsApplied.map((job, index)=> true ? (
            <tr key={index} >
              <td className='py-2 px-4 flex items-center gap-2 border-b ' ><img className='w-8 h-8' src={job.logo} alt="" />{job.company}</td>
